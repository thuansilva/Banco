		...
		<form method="post"  action="/Banco/conexao/conexaoEmprestimo.php">
			...
			<div class="form-row">
				<div class="form-group col-md-4">
					<input type="number" form="formPesquisarObras" class="form-control" placeholder="Digite o identificador do bibliotecário(a)" name="bibliotecario" required autofocus>
				</div>
				<div class="form-group col-md-4" >
